...
let totalAmount= await userDataHelper.getTotalAmount(req.session.user._id)
// if(req.body['savedAddress']){
//     console.log("addressIdddddddddddddddddddd",req.body['savedAddress']);
//     let savedAddress = await userHelper.findSavedAddress(req.body['savedAddress'])
//     let order={
//         _id : savedAddress._id,
//     fname : savedAddress.fname,
//     lname : savedAddress.lname,
//     address : savedAddress.address,
//     city : savedAddress.city,
//     state : savedAddress.state,
//     locationMark : savedAddress.locationMark,
//     pin : savedAddress.pin,
//     number : savedAddress.mobile,
//     'payment-method':req.body['payment-method']
//     }

//     userHelper.placeOrder(order,product,totalAmount,req.session.user._id).then((orderId)=>{
//         if(req.body['payment-method']==='COD'){
//             res.json({codSuccess:true})
//           }else if(req.body['payment-method']==='razorpay'){
...
//             })
//           }else if(req.body['payment-method']==='paypal'){
//             console.log("paypal s");

//             res.json({isPaypal:true,orderID:orderId})
//           }
//         })
